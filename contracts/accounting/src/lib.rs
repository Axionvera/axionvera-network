...
impl AccountingOperation {
    pub fn symbol(self) -> Symbol {
        match self {
            ...
            AccountingOperation::TreasuryDepositFee => symbol_short!("dep_fee"),
            AccountingOperation::TreasuryWithdrawalFee => symbol_short!("wd_fee"),
            AccountingOperation::TreasuryRewardFee => symbol_short!("rw_fee"),
