...
fn checked_accrued_rewards(balance: i128, delta: i128) -> Result<i128, VaultError> {
    balance
        .checked_mul(delta)
        .ok_or(VaultError::MathOverflow)?
...
fn accrue_position_rewards(state: &VaultState, position: &mut UserPosition) -> Result<(), VaultError> {
